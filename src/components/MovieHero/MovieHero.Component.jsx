...
const MovieHero = () => {
  ...
  return (
    <>
    <div>
        {/* Mobile and Medium Screen Sizes */}
      ...
      style={{height:"30rem"}}>
        <div className='absolute z-10 w-full h-full' style={{backgroundImage : "linear-gradient(90deg, rgb(34, 34, 34) 14.95%, rgba(34, 34, 34) 30.3%, rgba(34, 34, 34, 0.90) 38.3%, rgba(34, 34, 34, 0.60) 58.3%, rgba(34, 34, 34, 0.04) 100%)"}}>
